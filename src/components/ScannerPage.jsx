...
function ScannerPage() {
    ...
    return (
        <div className="relative min-h-screen bg-black text-white font-sans selection:bg-flux-primary selection:text-white flex flex-col items-center px-4">

            {/* Main Content Wrapper - Centered Vertically & Horizontally */}
            <div className="flex-grow flex flex-col items-center justify-center w-full max-w-lg py-12">
...
const LEGAL_CONTENT = {
    ...
    privacy: (
        <>
            ...
            <p>If you believe that any information we are holding on you is incorrect or incomplete, please write to 202, O Wing, Savannah, Baif Road, Wagholi, Pune, Maharashtra - 412207 . or contact us at 9507510924 or adityakksingh23@gmail.com as soon as possible. We will promptly correct any information found to be incorrect.</p>
        </>
    ),
    refund: (
        <>
